...
import org.usfirst.frc.team5526.robot.commands.*;
...
public class OI {
	...
	public OI() {
		...
		JoystickButton l2 = new JoystickButton(joy, 7);
		JoystickButton r2 = new JoystickButton(joy, 18);
		JoystickButton l1 = new JoystickButton(joy, 5);
		JoystickButton r1 = new JoystickButton(joy, 9);
